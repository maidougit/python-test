...
from app.modules import Admin, Tag, Movie, Preview, User, Comment, Moviecol, Oplog, Adminlog, UserLog,Auth,Role
...
# 电影添加 problem  注意文件引用是否正确  secure_filename中文乱码
...
# 电影编辑 problem  注意文件引用是否正确  secure_filename中文乱码
...
def movie_edit(id=None):
    ...
    return render_template("admin/movie_edit.html", form=form, movie=movie)  # 电影列表
