...
# 15. driver.switch_to.parent_content(): 跳出当前一级表单。该方法默认对应于离它最近的switch_to.frame()
# 方法。
...
#  '__subclasshook__', '__weakref__', '_execute', '_id', '_parent', '_upload', '_w3c', 'clear', 'click', 'find_element',
#  'find_element_by_class_name', 'find_element_by_css_selector', 'find_element_by_id', 'find_element_by_link_text',
#  'find_element_by_name', 'find_element_by_partial_link_text', 'find_element_by_tag_name', 'find_element_by_xpath',
...
#  'find_elements_by_tag_name', 'find_elements_by_xpath', 'get_attribute', 'id', 'is_displayed', 'is_enabled',
#  'is_selected', 'location', 'location_once_scrolled_into_view', 'parent', 'rect', 'screenshot', 'screenshot_as_base64',
...
# 5.
# element.is_displayed(): 返回元素结果是否可见（True
# 或
# False）
# 6.
# element.is_selected(): 返回元素结果是否被选中（True
# 或
# False）
# 7.
